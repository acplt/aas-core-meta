...
class Test_matches_xs_date_time_stamp_utc(unittest.TestCase):
    def test_empty(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("")

    def test_date(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("2022-04-01")

    def test_date_with_time_zone(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("2022-04-01Z")

    def test_date_time_without_zone(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("2022-04-01T01:02:03")

    def test_date_time_with_offset(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("2022-04-01T01:02:03+02:00")

    def test_date_time_with_UTC(self) -> None:
        assert v3.matches_xs_date_time_stamp_UTC("2022-04-01T01:02:03Z")

    def test_date_time_without_seconds(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("2022-04-01T01:02Z")

    def test_date_time_without_minutes(self) -> None:
        assert not v3.matches_xs_date_time_stamp_UTC("2022-04-01T01Z")
...
class Test_matches_xs_date_time_stamp(unittest.TestCase):
    def test_empty(self) -> None:
        assert not v3.matches_xs_date_time_stamp("")

    def test_date(self) -> None:
        assert not v3.matches_xs_date_time_stamp("2022-04-01")

    def test_date_with_time_zone(self) -> None:
        assert not v3.matches_xs_date_time_stamp("2022-04-01Z")

    def test_date_time_without_zone(self) -> None:
        assert not v3.matches_xs_date_time_stamp("2022-04-01T01:02:03")

    def test_date_time_stamp_with_offset(self) -> None:
        assert v3.matches_xs_date_time_stamp("2022-04-01T01:02:03+02:00")

    def test_date_time_stamp_with_invalid_offset(self) -> None:
        assert not v3.matches_xs_date_time_stamp("2022-04-01T01:02:03+15:00")

    def test_date_time_stamp_with_UTC(self) -> None:
        assert v3.matches_xs_date_time_stamp("2022-04-01T01:02:03Z")

    def test_date_time_without_seconds(self) -> None:
        assert not v3.matches_xs_date_time_stamp("2022-04-01T01:02Z")

    def test_date_time_without_minutes(self) -> None:
        assert not v3.matches_xs_date_time_stamp("2022-04-01T01Z")
            ...
            with threading.Lock():
                ...
                Test_assertions._atok_symbol_table_and_constraints_by_class_singleton = (
                    ...
                    .load_atok_symbol_table_and_infer_constraints_for_schema(
                        model_path=pathlib.Path(v3.__file__)
                    )
                )
                # fmt: on
